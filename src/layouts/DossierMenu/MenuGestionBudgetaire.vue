              ...
              <ul class="nav nav-collapse">
                ...
                <li>
                  <a
                    href=""
                    @click.prevent="
                      activedOptionMenu('InformationBudgetModifier')
                    "
                  >
                ...
                <li>
                  <a
                    href=""
                    @click.prevent="activedOptionMenu('mettreDecisionBudget')"
                  >
                    <span class="sub-item">Viser le budget </span>
                  </a>
                </li>
                <li>
                  <a
              ...
              <ul class="nav nav-collapse">
                ...
                <li>
                  <a
                    href=""
                    @click.prevent="
                      activedOptionMenu('InformationBordereauOPAnnulation')
                    "
                  >
              ...
              <ul class="nav nav-collapse">
                <li>
                  <a
                    href=""
                    @click.prevent="
                      activedOptionMenu('InfoBordOpProvisoirePerso')
                    "
                  >
                    <span class="sub-item">OP Provisoire</span>
                  </a>
                ...
                <li>
                  <a
                    href=""
                    @click.prevent="activedOptionMenu('InfoBordOpDirectPerso')"
                  >
                    <span class="sub-item">OP Direct</span>
                  </a>
                </li>
                ...
                <li>
                  <a
                    href=""
                    @click.prevent="
                      activedOptionMenu('infoBordereauTotalOpPerso')
                    "
                  >
                    <span class="sub-item">Voir ordre paiement</span>
                  </a>
    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner" v-else>
      <div class="sidebar-content">
        <ul class="nav nav-secondary">
          ...
          <li class="nav-item" v-if="AfficherSousMenuParametrebudget==8 && rolePerso_id!=1">
            <a data-bs-toggle="collapse" href="#base">
              <i class="fas fa-cog"></i>
              <p>Paramétre Budget</p>
              <span class="caret"></span>
          ...
          <li class="nav-item" v-if="AfficherSousMenuGestionBudget==9 && rolePerso_id!=1">
            <a data-bs-toggle="collapse" href="#sidebarLayouts">
              <i class="far fa-money-bill-alt"></i>
              <p>Gestion Budget</p>
              <span class="caret"></span>
          ...
          <li class="nav-item" v-if="AfficherSousMenuSaisirOPAutredepense==10 && rolePerso_id!=1">
            <a data-bs-toggle="collapse" href="#forms">
              <i class="fas fa-book-reader"></i>
              <p>Saisir OP Autre dépense</p>
              <span class="caret"></span>
          ...
          <li class="nav-item" v-if="AfficherSousMenuSaisirOPPersonnel==11 && rolePerso_id!=1">
            <a data-bs-toggle="collapse" href="#forms1">
              <i class="fas fa-book-reader"></i>
              <p>Saisir OP Personnel</p>
              <span class="caret"></span>
...
export default {
  ...
  computed: {
    ...
    AfficherSousMenu() {
     ...
     AfficherSousMenuParametrebudget() {
      // return (id) => {
      //   if (id != null && id != "") {
      const qtereel = this.getterPermission.find(
        (qtreel) => qtreel.utilisateur_id == this.nameUserid && qtreel.sous_menu==8
      );
    ...
    AfficherSousMenuGestionBudget() {
      // return (id) => {
      //   if (id != null && id != "") {
      const qtereel = this.getterPermission.find(
        (qtreel) => qtreel.utilisateur_id == this.nameUserid && qtreel.sous_menu==9
      );
     ...
     AfficherSousMenuSaisirOPAutredepense() {
      // return (id) => {
      //   if (id != null && id != "") {
      const qtereel = this.getterPermission.find(
        (qtreel) => qtreel.utilisateur_id == this.nameUserid && qtreel.sous_menu==10
      );
     ...
     AfficherSousMenuSaisirOPPersonnel() {
      // return (id) => {
      //   if (id != null && id != "") {
      const qtereel = this.getterPermission.find(
        (qtreel) => qtreel.utilisateur_id == this.nameUserid && qtreel.sous_menu==11
      );
