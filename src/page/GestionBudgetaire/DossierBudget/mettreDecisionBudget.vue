        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <tr
            v-if="
              fichierPDF !== 'pdf' && fichierPDF !== '' && fichierPDF !== null
            "
          >
            <td colspan="2" style="color: crimson">
              Veuillez charger un fichier pdf
            </td>
          </tr>
            </form>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <span v-if="AfficheMontantGlobal == 0" style="color: red"
                >Dotation global du projet est 0</span
              >
              <span v-if="AfficheMontantGlobal < 0" style="color: red"
                >Dotation global du projet est négatif</span
              >
            </form>
          </div>
          <div class="modal-footer">
  ...
  methods: {
    ...
    modificationSection() {
      var objetDirect1 = {
        ...
        statut: this.modNatureDepense.statut,
      };
