  ...
  <div class="container">
      ...
      <div class="card" style="box-shadow: 5px 5px #f9d531">
        <div class="card-header">
          <div class="page-header">
            <h6 class="fw-bold mb-3">Information sur la modification budgétaire</h6>
    ...
    <div class="modal fade" id="largeModal1" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Modifier Info Modification Budgétaire</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
    ...
    <div class="modal fade" id="largeModal" tabindex="-1">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Ajouter nfo Modification Budgétaire</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
