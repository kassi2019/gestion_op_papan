      ...
      <div class="card" style="box-shadow: 5px 5px #f9d531">
        <div class="card-header">
          <div class="page-header">
            <h6 class="fw-bold mb-3">Liste Fonction</h6>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr v-for="(item, index) in gettersFonction" :key="item.id">
                  <td>{{ index + 1 }}</td>
                  <td>{{ item.libelle }}</td>
                  ...
                  <td>
                    ...
                    <span
                      ...
                      style="cursor: pointer"
                      @click.prevent="supprimerFonction(item.id)"
                      >Supprimer</span
                    >
                  </td>
                </tr>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button
              ...
              data-bs-dismiss="modal"
              @click.prevent="this.getFonction()"
            >
              Fermer
            </button>
            <button
...
export default {
  ...
  computed: {
    ...mapGetters("Personnel", ["gettersFonction"]),
  },
  methods: {
