  ...
  <div class="container">
      ...
      <div class="card" style="box-shadow: 5px 5px #f9d531">
        <div class="card-header">
          <div class="page-header">
            <h6 class="fw-bold mb-3">Liste Diplôme</h6>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr v-for="(item, index) in gettersDiplome" :key="item.id">
                  <td>{{ index + 1 }}</td>
                  <td>{{ item.libelle }}</td>
                  ...
                  <td>
                    ...
                    <span
                      ...
                      style="cursor: pointer"
                      @click.prevent="supprimerDiplome(item.id)"
                      >Supprimer</span
                    >
                  </td>
                </tr>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Modifier Diplôme</h5>
            <button
              type="button"
              class="btn-close"
    ...
    >
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Ajouter Diplôme</h5>
            <button
              type="button"
              class="btn-close"
              data-bs-dismiss="modal"
...
export default {
  ...
  computed: {
    ...mapGetters("Personnel", ["gettersDiplome"]),
  },
  methods: {
    ...
    AfficheModalModification(id) {
      this.modNatureDepense = this.gettersDiplome.find(
        (items) => items.id == id
      );
    },
    EnregistrerSection() {
